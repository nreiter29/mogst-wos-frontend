import { Box, Button, Heading, HStack, IconButton, Image, Popover, PopoverArrow, PopoverBody, PopoverCloseButton, PopoverContent, PopoverHeader, PopoverTrigger, Portal, Text, VStack } from '@chakra-ui/react'
...
const AccountMenu: React.FC<{ isLoading: boolean, activeCustomerData?: IActiveCustomerData | undefined, refetch: () => void}> = ({ isLoading, activeCustomerData, refetch }) => {
